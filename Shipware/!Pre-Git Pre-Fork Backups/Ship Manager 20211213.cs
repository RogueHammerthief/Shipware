...
{
    //ARCHIVE: Created before removing DefenseShields integration from the script.
    ...
    */
    ...
    partial class Program : MyGridProgram
    {
        ...
        public Program()
        {
            ...
            {
                //Evaluate does initialize some variables. There's two that we'll need in order to
                //run Save and not crash the script.
