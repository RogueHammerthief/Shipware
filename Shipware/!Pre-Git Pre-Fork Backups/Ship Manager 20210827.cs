...
{
    //ARCHIVE: Created in the process of modifying AutoPopulate to use the configureTally method.
    //Done because I think commenting this stuff out is screwing with the IDE.
            ...
            /*
    {
        ...
        if (smallPanels.Count > 0 || largePanels.Count > 0)
        {
            ...
            List<IMyTerminalBlock> panels = smallPanels;
